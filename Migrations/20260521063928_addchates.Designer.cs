...
namespace Career_Path.Migrations
{
    ...
    [Migration("20260521063928_addchates")]
    partial class addchates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Career_Path.Entities.CommentReaction", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Career_Path.Entities.CommentReply", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Career_Path.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Career_Path.Entities.Post", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Career_Path.Entities.PostComment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Career_Path.Entities.PostLike", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Career_Path.Entities.ReplyReaction", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Career_Path.Entities.UserFollow", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("UserFollows", t =>
                        {
                            t.HasCheckConstraint("CK_UserFollow_NotSelf", "\"FollowerId\" <> \"FollowingId\"");
                        });
                });
            ...
            modelBuilder.Entity("Career_Path.Entities.CommentReaction", b =>
                {
                    b.HasOne("Career_Path.Entities.PostComment", "Comment")
                        .WithMany("Reactions")
            ...
            modelBuilder.Entity("Career_Path.Entities.Message", b =>
                {
                    b.HasOne("Career_Path.Entities.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Career_Path.Entities.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Career_Path.Entities.PostComment", b =>
                {
                    b.HasOne("Career_Path.Entities.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Career_Path.Entities.ReplyReaction", b =>
                {
                    b.HasOne("Career_Path.Entities.CommentReply", "Reply")
                        .WithMany("Reactions")
            ...
            modelBuilder.Entity("Career_Path.Entities.UserFollow", b =>
                {
                    b.HasOne("Career_Path.Entities.ApplicationUser", "Follower")
                        .WithMany("Following")
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Career_Path.Entities.ApplicationUser", "Following")
                        .WithMany("Followers")
