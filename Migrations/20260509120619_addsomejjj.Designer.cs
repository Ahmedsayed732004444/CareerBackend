...
namespace Career_Path.Migrations
{
    ...
    [Migration("20260509120619_addsomejjj")]
    partial class addsomejjj
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.ModelExtration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.PhaseResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.PhaseSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.ProjectImprovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.PrompetRoadMap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.Roadmap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.RoadmapPhase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.ModelExtration", b =>
                {
                    b.HasOne("Career_Path.Entities.ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("Career_Path.Entities.Ai.ModelExtration", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsMany("Career_Path.Entities.Ai.Education", "Education", b1 =>
                        {
                    ...
                    b.OwnsMany("Career_Path.Entities.Ai.Experience", "Experience", b1 =>
                        {
                            b1.Property<int>("ModelExtrationId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.PhaseResource", b =>
                {
                    b.HasOne("Career_Path.Entities.Ai.RoadmapPhase", "RoadmapPhase")
                        .WithMany("Resources")
            ...
            modelBuilder.Entity("Career_Path.Entities.Ai.ProjectImprovement", b =>
                {
                    b.HasOne("Career_Path.Entities.Ai.Roadmap", "Roadmap")
